...
(async function takeScreenshot() {
    ...
    try {
        ...
        await driver.get('file:///c:/temp/code_renderer2.html');
        ...
        fs.writeFileSync('task2_code_screenshot.png', encodedString, 'base64');
        console.log("Done! saved as task2_code_screenshot.png");
    } catch (e) {
